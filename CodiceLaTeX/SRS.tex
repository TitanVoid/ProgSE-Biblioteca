...
\begin{document}
    ...
    \subsection{Descrizione dei Casi d'Uso}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C1 - Visualizza lista libri}]
            ...
            \textbf{Precondizioni:} L’amministratore ha avviato l’applicazione;\\L’amministratore si trova su una schermata diversa da quella di visualizzazione dei libri;\\L'archivio dei libri è stato caricato correttamente dal file all'avvio del sistema.\vspace{.2cm}
            ...
            \begin{enumerate}
                ...
                \item L’amministratore può interagire con la lista.
            \end{enumerate}

            \textbf{Flussi di eventi alternativi:}\vspace{-0.2cm}
            \begin{enumerate}
                \item[3a.] Viene visualizzata una tabella vuota;\vspace{-0.2cm}
                \begin{enumerate}
                    \item[3a.1] L'esecuzione riprende dal passo 4.
                \end{enumerate}
            \end{enumerate}                
        \end{tcolorbox}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C2 - Visualizza lista utenti}]
            ...
            \textbf{Precondizioni:} L’amministratore ha avviato l’applicazione;\\L’amministratore si trova su una schermata diversa da quella di visualizzazione degli utenti;\\L'archivio degli utenti è stato caricato correttamente dal file all'avvio del sistema.\vspace{.2cm}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C3 - Visualizza lista prestiti}]
            ...
            \textbf{Precondizioni:} L’amministratore ha avviato l’applicazione;\\L’amministratore si trova su una schermata diversa da quella di visualizzazione dei prestiti;\\L'archivio dei prestiti è stato caricato correttamente dal file all'avvio del sistema. \vspace{.2cm}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C4 - Inserisci libro}]
            ...
            \begin{enumerate}
                ...
                \item Viene mostrata una nuova finestra con i campi richiesti per l'inserimento (Titolo, Autori, Anno di pubblicazione, ISBN e Numero di copie disponibili);
            ...
            \begin{enumerate}
                \setlength\itemsep{-0.3em}
                \item[4a.] L’amministratore preme il pulsante “Annulla”; 
                \begin{enumerate}
                    \item[4a.1] L’esecuzione termina.
                \end{enumerate}
                \item[5a.] Il sistema riscontra degli errori nel formato dei campi inseriti; 
                \begin{enumerate}
                    \setlength\itemsep{-0.3em}
                ...
                \end{enumerate}
                \item[5b.] Il sistema si accorge che non sono stati inseriti tutti i campi obbligatori; 
                \begin{enumerate}
                    \setlength\itemsep{-0.3em}
                ...
                \end{enumerate}
                \item[6a.] L’ISBN inserito corrisponde ad un libro già presente nell’archivio; 
                \begin{enumerate}
                    \setlength\itemsep{-0.3em}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C5 - Modifica libro}]
            ...
            \textbf{Precondizioni:} L’amministratore si trova sulla schermata di visualizzazione e gestione dei libri;\\È presente almeno un libro nella lista dei libri;\\L'archivio dei libri è stato caricato correttamente dal file all'avvio del sistema. \vspace{.2cm}
            ...
            \begin{enumerate}
                \setlength\itemsep{-0.3em}
                \item[5a.] L’amministratore preme il pulsante “Annulla”; 
                \begin{enumerate}
                    \item[5a.1] L’esecuzione termina.
                \end{enumerate}
                \item[6a.] Il sistema riscontra degli errori nel formato dei campi inseriti; 
                \begin{enumerate}
                    \setlength\itemsep{-0.3em}
                ...
                \end{enumerate}
                \item[6b.] Il sistema si accorge che non sono stati inseriti tutti i campi obbligatori; 
                \begin{enumerate}
                    \setlength\itemsep{-0.3em}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C7 - Inserisci utente}]
            ...
            \begin{enumerate}
                \setlength\itemsep{-0.3em}
                \item L’amministratore preme il pulsante “Aggiungi”;
                \item Viene mostrata una nuova finestra con i campi richiesti per l'inserimento (Nome, Cognome, Matricola ed E-mail istituzionale); 
            ...
            \begin{enumerate}
                ...
                \begin{enumerate}
                    ...
                    \item[5b.2] L’esecuzione riprende dal passo 3.
                \end{enumerate}
                \item[6a.] La matricola inserita corrisponde ad un utente già presente nell’archivio; 
                \begin{enumerate}
                    \setlength\itemsep{-0.3em}
                    \item[6a.1] Viene visualizzato un messaggio di errore;
                    \item[6a.2] L’esecuzione riprende dal passo 3.
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C8 - Modifica utente}]
            ...
            \textbf{Precondizioni:} L’amministratore si trova sulla schermata di visualizzazione e gestione degli utenti;\\È presente almeno un utente nella lista degli utenti;\\L'archivio degli utenti è stato caricato correttamente dal file all'avvio del sistema.\vspace{.2cm}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C10 - Ricerca libro}]
            ...
            \textbf{Precondizioni:} L’amministratore si trova sulla schermata di visualizzazione e gestione dei libri;\\L'archivio dei libri è stato caricato correttamente dal file all'avvio del sistema.\vspace{.2cm}
            ...
            \begin{enumerate}
                \setlength\itemsep{-0.3em}
                \item[2a.] L’amministratore cancella la sottostringa dalla barra di ricerca; 
                \begin{enumerate}
                    \setlength\itemsep{-0.3em}
                    \item[2a.1] Viene ripristinata la visualizzazione della lista completa dei libri;
                \end{enumerate}
                \item[3a.] Il sistema non trova alcuna corrispondenza per la sottostringa inserita; 
                \begin{enumerate}
                    \setlength\itemsep{-0.3em}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C11 - Ricerca libro con filtro}]
            \textbf{Attori presenti:} Amministratore.\vspace{.2cm}     
                
            \textbf{Precondizioni:} L’amministratore si trova sulla schermata di visualizzazione e gestione dei libri;\\L'archivio dei libri è stato caricato correttamente dal file all'avvio del sistema.\vspace{.2cm}
                
            \textbf{Postcondizioni:} Vengono mostrati soltanto i libri che soddisfano il criterio o i criteri di ricerca applicati;\\I libri vengono visualizzati in ordine alfabetico, per titolo.\vspace{.2cm}

            \textbf{Flusso di eventi normale:}\vspace{-0.2cm}
            \begin{enumerate}
                \setlength\itemsep{-0.3em}
                \item L’amministratore preme il pulsante "Filtri”;
                \item Viene visualizzata la schermata di selezione dei filtri di ricerca avanzata;
                \item L’amministratore seleziona uno o più criteri di ricerca da applicare, riempiendo (laddove presenti) i campi necessari;
                \item L’amministratore preme il pulsante “Applica filtri”;
                \item Il sistema convalida, se necessario, i dati di input per i filtri (formato corretto);
                \item Il sistema effettua in tempo reale la ricerca;
                \item Vengono visualizzati soltanto i libri che soddisfano i criteri applicati;
            \end{enumerate}

            \textbf{Flussi di eventi alternativi:}\vspace{-0.2cm}
            \begin{enumerate}
                \setlength\itemsep{-0.3em}
                \item[3a.] L’amministratore preme il pulsante “Rimuovi filtri”; 
                \begin{enumerate}
                    \setlength\itemsep{-0.3em}
                    \item[3a.1] Viene ripristinata la visualizzazione della lista completa dei libri;
                \end{enumerate}
                \item[5a.] Il sistema riscontra degli errori nel formato dei campi inseriti;
                \begin{enumerate}
                    \setlength\itemsep{-0.3em}
                ...
                \begin{enumerate}
                    ...
                    \item[5b.2] L’esecuzione riprende dal passo 3.
                \end{enumerate}
                \item[6a.] Il sistema non trova alcuna corrispondenza per i criteri di ricerca applicati; 
                \begin{enumerate}
                    \setlength\itemsep{-0.3em}
                    \item[6a.1] Viene visualizzata una tabella vuota con un messaggio informativo;
                    \item[6a.2] L’esecuzione riprende dal passo 3.
                \end{enumerate}
            \end{enumerate}       
        \end{tcolorbox}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C12 - Ricerca utente}]
            ...
            \textbf{Precondizioni:} L’amministratore si trova sulla schermata di visualizzazione e gestione degli utenti;\\L'archivio degli utenti è stato caricato correttamente dal file all'avvio del sistema.\vspace{.2cm}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C13 - Registra prestito}]
            ...
            \textbf{Precondizioni:} L’amministratore si trova sulla schermata di visualizzazione e gestione dei prestiti;\\Gli archivi dei libri, degli utenti e dei prestiti sono stati caricati correttamente dal file all'avvio del sistema;\\L’utente che ha richiesto il prestito è presente all’interno del sistema e non ha più di tre prestiti attivi;\\Il libro da prestare è presente all’interno del sistema ed è disponibile. \vspace{.2cm}
            ...
            \begin{enumerate}
                ...
                \item Viene mostrata una nuova finestra con i campi richiesti per l'inserimento (Matricola dello studente che richiede il prestito, ISBN del libro da prestare e Data prevista di restituzione);
            ...
            \begin{enumerate}
                ...
                \begin{enumerate}
                    ...
                    \item[5b.2] L'esecuzione riprende dal passo 3.
                \end{enumerate}
                \item[5c.] Il sistema si accorge che è stata inserita una data antecedente alla data odierna;\vspace{-0.2cm}
                \begin{enumerate}
                    \item[5c.1] Viene visualizzato un messaggio di errore e viene evidenziato il 		          campo da modificare;
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C14 - Registra restituzione}]
            ...
            \textbf{Precondizioni:} L’amministratore si trova sulla schermata di visualizzazione e gestione dei prestiti;\\È presente almeno un prestito nella lista dei prestiti;\\Gli archivi dei libri, degli utenti e dei prestiti sono stati caricati correttamente dal file all'avvio del sistema.\vspace{.2cm}
            ...
            \begin{enumerate}
                ...
                \item Il sistema rimuove il prestito dalla schermata di visualizzazione dei prestiti;
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C15 - Estendi prestito}]
            ...
            \textbf{Precondizioni:} L’amministratore si trova sulla schermata di visualizzazione e gestione dei prestiti;\\È presente almeno un prestito nella lista dei prestiti;\\L'archivio dei prestiti è stato caricato correttamente dal file all'avvio del sistema.\vspace{.2cm}
            ...
            \begin{enumerate}
                ...
                \item Viene mostrata una nuova finestra con la data prevista di restituzione corrente del prestito selezionato;
                \item L’amministratore modifica il campo;
                \item L’amministratore preme il pulsante “Conferma”;
