    ...
    \addcontentsline{toc}{section}{Descrizione introduttiva}
        ...
        \subsection*{Stakeholder}
            ...
            \subsubsection*{Stakeholder Esterni}
                L'\textbf{Utente} (ovvero lo \textbf{Studente universitario}) che , sebbene non utilizzi direttamente l'interfaccia grafica, è il beneficiario finale del sistema.
    ...
    \subsection{Requisiti Funzionali}
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{Funzionalità individuali - IF}]
            \begin{itemize}[itemsep=6pt]
                ...
                \\Premendo l’apposito pulsante, comparirà una finestra aggiuntiva (vedere \hyperlink{UI-6}{UI-6}) in cui si dovranno inserire tutti i campi necessari, coerentemente a quanto definito in \hyperlink{DF-2}{DF-2}. 
                ...
                \\Il sistema mostrerà un messaggio di conferma all’amministratore (vedere \hyperlink{UI-8}{UI-8}), offrendogli la possibilità di portare a termine o annullare l’operazione tramite la pressione dei rispettivi pulsanti.
                ...
                \\Premendo l’apposito pulsante, comparirà una finestra aggiuntiva (vedere \hyperlink{UI-6}{UI-6}) in cui si dovranno inserire tutti i campi necessari, coerentemente a quanto definito in \hyperlink{DF-3}{DF-3}.
                \\Al termine dell’inserimento, sarà possibile confermare oppure annullare l’operazione mediante la pressione dei rispettivi pulsanti.
                ...
                \\Premendo l’apposito pulsante, comparirà una finestra aggiuntiva (vedere \hyperlink{UI-6}{UI-6}) in cui si dovranno inserire tutti i campi necessari, coerentemente a quanto definito in \hyperlink{DF-4}{DF-4}.
                \\All'atto di una registrazione, il sistema imposterà automaticamente la data prevista di restituzione a quattordici giorni dalla data corrente, ma l'amministratore sarà libero di impostarla a suo piacimento.\vspace{.2cm}
                \\Al termine dell’inserimento, sarà possibile confermare oppure annullare l’operazione mediante la pressione dei rispettivi pulsanti.
                ...
                \begin{itemize}[label=$\bullet$]
                    ...
                    \item Aggiunta del prestito alla schermata di visualizzazione dei prestiti attivi.
                \end{itemize}
                Nel caso in cui non siano stati inseriti tutti i campi necessari, oppure nel caso di inserimento di campi errati (vedere \hyperlink{DF-4}{DF-4} per le informazioni relative al formato dei dati), non sarà possibile confermare la registrazione.\vspace{.2cm}
                \\Se il codice identificativo del libro e/o la matricola dell’utente forniti in input non dovessero essere presenti nelle rispettive liste, l'operazione di registrazione sarà bloccata e verrà visualizzato un messaggio di errore (vedere \hyperlink{UI-9}{UI-9}).
                \\Allo stesso modo, se l'utente dovesse aver raggiunto il limite massimo di prestiti consentiti, oppure se il libro non dovesse avere copie disponibili all'atto della richiesta, verrà visualizzato un avviso.

                \hypertarget{IF-12}{\item[\textbf{IF-12}]}\textbf{Visualizzazione dei prestiti per data prevista di restituzione}
                \\La visualizzazione dei prestiti contenuti nella lista dei prestiti avviene sempre in ordine cronologico crescente o decrescente, rispetto alla data di restituzione.
                ...
                \\L'applicazione permette all'amministratore di filtrare l'elenco dei prestiti visualizzato, limitando i risultati ai soli prestiti che si trovano in un determinato stato.\vspace{.2cm}
                \\A seguito dell'operazione di filtraggio, l'elenco dei prestiti dovrà essere presentato rispettando l'ordinamento definito in \hyperlink{IF-12}{IF-12}. 
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{Business Flow - BF}]
            \begin{itemize}[itemsep=6pt]             
                ...
                \begin{itemize}[label=$\bullet$]
                    ...
                    \item Il libro deve essere presente nell’elenco di libri della biblioteca;
                ...
                \\Qualora l’utente non dovesse essere presente in tale elenco, quest’ultimo fornirà i propri dati personali all’amministratore, che potrà decidere di inserirlo mediante l’operazione definita in \hyperlink{IF-6}{IF-6}.
                ...
                \begin{itemize}[label=$\bullet$]
                    ...
                    \item Verificare che sia disponibile per il prestito;
                ...
                \\All’atto della richiesta di restituzione, l’utente dovrà identificarsi all’amministratore e presentare il libro che intende restituire.
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{Esigenze di Dati e Informazioni - DF}]
            \begin{itemize}[itemsep=6pt]
                ...
                \\L’intero archivio della biblioteca dovrà essere memorizzato, in maniera del tutto automatica, all’interno di un file.\vspace{.2cm}
                \\L’archiviazione dovrà avvenire ogni qualvolta l'applicazione viene chiusa.
                \\Al suo riavvio, il sistema dovrà ripristinare automaticamente lo stato dell'archivio, leggendolo dal file.      
                ...
                \begin{itemize}[label=$\bullet$]
                    ...
                    \item I campi “Nome” e “Cognome” di ogni autore dovranno essere stringhe di caratteri non numerici (con una lunghezza compresa tra i tre ed i venticinque caratteri);
                    \item Il campo “Anno di pubblicazione” dovrà essere un numero compreso tra zero e l’anno corrente;
                    \item Il campo “Codice identificativo” dovrà essere il codice ISBN del libro, e dunque aderire allo standard ISO 2108: 2017;
                ...
                Nello specifico: 
                \begin{itemize}[label=$\bullet$]
                    \item I campi “Nome” e “Cognome” dovranno essere stringhe di caratteri non numerici (con una lunghezza compresa tra i tre ed i venticinque caratteri);
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{Interfaccia Utente - UI}]
            \begin{itemize}[itemsep=6pt]
                ...
                \begin{enumerate}
                    \item Menù a tendina: sarà presente un menù che consentirà di passare da una schermata di visualizzazione all'altra;
                    \item Filtri: saranno presenti delle checkbox per la selezione del filtro di visualizzazione da applicare alla lista dei prestiti (vedere \hyperlink{IF-14}{IF-14}); 
                ...
                \\L'applicazione includerà una schermata principale dotata di tre pulsanti, chiamati "LIBRI", "UTENTI" e "PRESTITI", che permetteranno di accedere ad una delle rispettive schermate di visualizzazione (descritte nel dettaglio in \hyperlink{UI-2}{UI-2}, \hyperlink{UI-3}{UI-3} e \hyperlink{UI-4}{UI-4}).\vspace{.2cm}
                ...
                \\Tale schermata conterrà i campi da inserire, che varieranno in base alla tipologia dell'inserimento (vedere \hyperlink{DF-2}{DF-2}, \hyperlink{DF-3}{DF-3} e \hyperlink{DF-4}{DF-4} per l'elenco dettagliato dei campi che verranno mostrati).
                ...
                \\All'atto di una qualsiasi operazione di modifica (vedere \hyperlink{IF-2}{IF-2} e \hyperlink{IF-7}{IF-7}) oppure di estensione (vedere \hyperlink{IF-15}{IF-15}), all'amministratore verrà mostrata una schermata apposita.\vspace{.2cm}
                ...
                \\L'applicazione mostrerà una schermata aggiuntiva contenente un messaggio, che specificherà la tipologia di errore che si è verificato.
                \\Inoltre, tale schermata si occuperà anche di offrire all'amministratore un'indicazione su come risolvere il problema, in modo tale da permettergli di portare a termine con successo l'operazione.
            \end{itemize}
        \end{tcolorbox}
    ...
    \subsection{Descrizione dei Casi d'Uso}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C1 - Visualizza lista libri}]
            ...
            \begin{enumerate}
                ...
                \item L’amministratore preme, all'interno del menù, il pulsante “Libri”; 
            ...
            \begin{enumerate}
                ...
                \begin{enumerate}
                    \item[1a.1] L'amministratore preme il pulsante "LIBRI";
                    \item[1a.2] L'esecuzione riprende dal passo 3.
                \end{enumerate}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C2 - Visualizza lista utenti}]
            ...
            \begin{enumerate}
                \setlength\itemsep{-0.3em}
                \item L’amministratore preme il pulsante apposito per aprire il menù a tendina; 
                \item L’amministratore preme, all'interno del menù, il pulsante “Utenti”; 
            ...
            \begin{enumerate}
                \item[1a.] L'amministratore visualizza la schermata principale dell'applicazione;\vspace{-0.2cm}
                \begin{enumerate}
                    \item[1a.1] L'amministratore preme il pulsante "UTENTI";
                    \item[1a.2] L'esecuzione riprende dal passo 3.                \end{enumerate}
                \item[3a.] Viene visualizzata una tabella vuota.
            \end{enumerate}       
        \end{tcolorbox}
        ...
        \begin{tcolorbox}[breakable, colback=white,colframe=black!80!white,title=\textbf{C3 - Visualizza lista prestiti}]
            ...
            \begin{enumerate}
                \setlength\itemsep{-0.3em}
                \item L’amministratore preme il pulsante apposito per aprire il menù a tendina; 
                \item L’amministratore preme, all'interno del menù, il pulsante “Prestiti”; 
            ...
            \begin{enumerate}
                \item[1a.] L'amministratore visualizza la schermata principale dell'applicazione;\vspace{-0.2cm}
                \begin{enumerate}
                    \item[1a.1] L'amministratore preme il pulsante "PRESTITI";
                    \item[1a.2] L'esecuzione riprende dal passo 3.
                \end{enumerate}
                \item[3a.] Viene visualizzata una tabella vuota.
            \end{enumerate}       
