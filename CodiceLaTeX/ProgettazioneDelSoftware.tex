    ...
    \subsection{Decomposizione in moduli}
        \subsubsection{Descrizione delle classi individuate}
            ...
            \begin{itemize}[label=$\bullet$]
                ...
                \item \textbf{Filtro}: classe enumerativa che definisce tre criteri di filtraggio: \texttt{TUTTI}, \texttt{ATTIVI} e \texttt{CONCLUSI}. Questa classe è utilizzata per l'applicazione di criteri di selezione sull'insieme dei prestiti; 
            ...
            \\Per lo stesso motivo, all'interno del diagramma viene omessa anche l'implementazione dell'interfaccia Comparable, che sarà implementata dalle classi: Prestito, Libro, Matricola, ISBN e Persona (con le proprie specializzazioni). 
        \newpage
        ...
        \begin{figure}[h!]
            \begin{adjustbox}{width=.45\paperwidth, height=.4\paperheight, center, margin= 0cm .6cm 0cm .1cm}
