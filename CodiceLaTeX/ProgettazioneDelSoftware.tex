...
\begin{document}
    ...
    \subsection{Decomposizione in moduli}
        ...
        \begin{figure}[h!]
            \begin{adjustbox}{width=.4\paperwidth, height=.5\paperheight, center, margin= 0cm .6cm 0cm .1cm}
                \includesvg{diagrammaDeiPackageNonDettagliato.svg}    
            \end{adjustbox}
        ...
        \begin{figure}[h!]
            \begin{adjustbox}{width=.74\paperwidth, height=.75\paperheight, center, margin= 0cm .3cm 0cm .1cm}
                \includesvg{diagrammaDeiPackage.svg}    
            \end{adjustbox}
    ...
    \subsection{Principi di buona progettazione}
        ...
        \\In questo modo è possibile ottenere un codice chiaro (secondo quanto affermato dal principio \emph{KISS} - \emph{Keep It Simple, Stupid!}) e facilmente manutenibile.\vspace{.2cm}
