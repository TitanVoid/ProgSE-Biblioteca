...
public class Libro implements Comparable<Libro>, Serializable {
     ...
     */
    public Libro(String titolo, int annoPubblicazione, ISBN isbn, int copieDisponibili, List<Autore> autori) {
        this.titolo = titolo;
     ...
     */
    public static boolean verificaLibro(List<Autore> autori, String titolo, int annoPubblicazione, ISBN isbn, int copieDisponibili) {
        return false;
    }
