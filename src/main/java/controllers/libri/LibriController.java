...
public class LibriController extends BaseController implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        titleClm.prefWidthProperty().bind(tableLibri.widthProperty().multiply(0.20));
        authorsClm.prefWidthProperty().bind(tableLibri.widthProperty().multiply(0.20));
        publishYearClm.prefWidthProperty().bind(tableLibri.widthProperty().multiply(0.20));
        idClm.prefWidthProperty().bind(tableLibri.widthProperty().multiply(0.20));
        copiesClm.prefWidthProperty().bind(tableLibri.widthProperty().multiply(0.20));
